...
const buscar = async () => {
  try {
    const res = await axios.get(`http://144.126.216.130:8000/api/reportes?id_propiedad=${id_propiedad.value}`)
...
const descargarPDF = (id_propiedad) => {
  const url = `http://144.126.216.130:8000/api/reportes/descargar/${id_propiedad}`
